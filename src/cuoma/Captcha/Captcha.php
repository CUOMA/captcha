 ...
 * @contact jmgolivares@gmail.com
 * @link http://www.garciaolivares.me
 * @date 2014-01-25
...
class Captcha {
    ...
    public static function create($id = null)
    {
        ...
        if(static::$config['type'] == 'alnum'):
            static::$char = Str::random(static::$config['length']);
        elseif(static::$config['type'] == 'num'):
            static::$char = substr(str_shuffle(str_repeat('0123456789', 5)), 0, static::$config['length']);
        endif;
